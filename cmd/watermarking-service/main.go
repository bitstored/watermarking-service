...
var (
	grpcAddr = flag.String("grpc", "localhost:4009", "gRPC API address")
	httpAddr = flag.String("http", "localhost:5009", "HTTP API address")
...
func main() {
	...
	pb.RegisterWatermarkingServer(gRPCServer, devServer)
